...
async fn index() -> impl Responder {
    let file = "/var/www/septblog/public/index.html".to_string();
...
async fn not_found() -> impl Responder {
    let file = "/var/www/septblog/public/404.html".to_string();
...
async fn about() -> impl Responder {
    let file = "/var/www/septblog/public/about.html".to_string();
...
async fn article(_name: web::Path<String>) -> impl Responder {
    let file = "/var/www/septblog/public/article.html".to_string();
...
async fn category(_path: web::Path<String>) -> impl Responder {
    let file = "/var/www/septblog/public/category.html".to_string();
...
async fn contact() -> impl Responder {
    let file = "/var/www/septblog/public/contact.html".to_string();
...
async fn user(_name: web::Path<String>) -> impl Responder {
    let file = "/var/www/septblog/public/user.html".to_string();
...
async fn install_stage_1() -> impl Responder {
    let file = "/var/www/septblog/public/install-stage-1.html".to_string();
...
async fn install_stage_2() -> impl Responder {
    let file = "/var/www/septblog/public/install-stage-2.html".to_string();
...
async fn install_finish() -> impl Responder {
    let file = "/var/www/septblog/public/install-finish.html".to_string();
...
async fn already_installed() -> impl Responder {
    let file = "/var/www/septblog/public/already-installed.html".to_string();
...
async fn css(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/css/".to_owned() + &name;
...
async fn js(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/js/".to_owned() + &name;
...
async fn js_view(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/js/View/".to_owned() + &name;
...
async fn js_viewmodel(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/js/ViewModel/".to_owned() + &name;
...
async fn js_model(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/js/Model/".to_owned() + &name;
...
async fn admin() -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/index.html".to_string();
...
async fn admin_path(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/".to_owned() + &name + ".html";
...
async fn admin_article_editor_id() -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/article-editor.html".to_string();
...
async fn admin_security(name: web::Path<String>) -> impl Responder {
    ...
    if path == "change-password" {
        file.push_str("/var/www/septblog/public/admin/change-password.html");
    } else if path == "change-email-address" {
        file.push_str("/var/www/septblog/public/admin/change-email-address.html");
    }
...
async fn admin_css(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/css/".to_owned() + &name;
...
async fn admin_js(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/js/".to_owned() + &name;
...
async fn admin_js_view(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/js/View/".to_owned() + &name;
...
async fn admin_js_viewmodel(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/js/ViewModel/".to_owned() + &name;
...
async fn admin_js_model(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/js/Model/".to_owned() + &name;
...
async fn admin_js_errors(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/js/Errors/".to_owned() + &name;
...
async fn admin_js_utils(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/js/Utils/".to_owned() + &name;
...
async fn admin_chartjs(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/chartjs@4.5.0/".to_owned() + &name;
...
async fn admin_fontawesome(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/fontawesome@6.3.0/".to_owned() + &name;
...
async fn admin_quill(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/quill@2.0.3/".to_owned() + &name;
...
async fn admin_bootstrap(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/bootstrap@5.2.3/".to_owned() + &name;
...
async fn admin_tagify(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/tagify/".to_owned() + &name;
...
async fn admin_assets_img(name: web::Path<String>) -> impl Responder {
    let file: String = "/var/www/septblog/public/admin/assets/img/".to_owned() + &name;
